...
class AutoGenerator {
        ...
        tableNames.forEach(table => {
            ...
            if (this.options.lang === 'ts') {
                ...
                if (creationOptionalFields.length) {
                    str += `export type #TABLE#OptionalAttributes = ${creationOptionalFields.map((k) => `"${(0, types_1.recase)(this.options.caseProp, k, false, k[0] === '_')}"`).join(' | ')};\n`;
    ...
    addField(table, field) {
        ...
        const fieldName = (0, types_1.recase)(this.options.caseProp, field, false, field[0] === '_');
    ...
    addTypeScriptFields(table, isInterface) {
        ...
        fields.forEach(field => {
            if (!this.options.skipFields || !this.options.skipFields.includes(field)) {
                const name = this.quoteName((0, types_1.recase)(this.options.caseProp, field, field[0] === '_'));
